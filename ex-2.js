...
const searchTitle = "A Tale of Two Cities";

console.log(findBookIndex(books, searchTitle));

// O(logn) เพราะว่า binary search เป็นการค้นหาที่ค่าตรงกลางเรื่อยๆจะลดจำนวนการค้นหาไปจำนวน loop ละครึ่งของจำนวน index
